...
import { TextBoxNew } from '../components/TextBoxNew/TextBoxNew';

export default {
    title: 'component/NEw',
    component: TextBoxNew,
} as ComponentMeta<typeof TextBoxNew>;

const templateOnChange = (e: React.ChangeEvent<HTMLInputElement>): void => {
    const { id, value } = e.target;
    console.log('partial', { [id]: value });
};
const Template: ComponentStory<typeof TextBoxNew> = (args) => <TextBoxNew {...args} />;
